...
#define SHADER_REG_SRV_DIFFUSE 1
#define SHADER_REG_SRV_NORMAL 2
#define SHADER_REG_SRV_SSAO 3
#define SHADER_REG_SRV_SHADOW 4
#define SHADER_REG_SRV_SHADOW_TRANSP 5
